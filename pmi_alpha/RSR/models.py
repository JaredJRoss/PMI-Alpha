...
class OCR(models.Model):
    ...
    NewPath = models.ForeignKey(Person, blank=True, null=True,on_delete=models.CASCADE)
...
class PersonToClubs_Hobbies(models.Model):
    PersonID = models.ForeignKey(Person, related_name='persontoclubshobbies_set',on_delete=models.CASCADE)
    CHID = models.ForeignKey(Clubs_Hobbies, related_name='persontoclubshobbies_set',on_delete=models.CASCADE)
